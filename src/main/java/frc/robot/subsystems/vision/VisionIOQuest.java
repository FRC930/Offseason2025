...
public class VisionIOQuest implements VisionIO {
  ...
  private final Transform3d ROBOT_TO_QUEST = new Transform3d(
    Units.inchesToMeters(0.5), Units.inchesToMeters(9.207), Units.inchesToMeters(.0), new Rotation3d(Rotation2d.fromDegrees(90)));
  ...
  public void updateInputs(VisionIOInputs inputs) {
    ...
    if (questNav.isConnected() && questNav.isTracking()) {
      ...
      for (PoseFrame questFrame : newFrames) {
        ...
        Pose3d questPose = new Pose3d(questFrame.questPose());
  ...
  public void setTagIdFilter(int[] filter) {
    System.out.printf("TagIdFilter not used for quest...");
  }
}
