...
/**
 * Base class for all behaviors in the reactive architecture.
 * Behaviors are self-registering and configure trigger-based reactions.
 *
 * <p>This is the foundation for both:
 * <ul>
 *   <li>{@link SubsystemBehavior} - Hardware behaviors that react to robot goals</li>
 *   <li>{@link GoalBehavior} - Goal behaviors that react to operator intent</li>
 * </ul>
 *
