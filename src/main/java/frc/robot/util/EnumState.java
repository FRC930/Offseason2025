...
/**
 * A utility class that automatically generates Triggers from any enum.
 * Makes state management dead simple for FRC subsystems.
 *
 * <h2>Basic Usage:</h2>
 * <pre>{@code
...
public class EnumState<E extends Enum<E>> {
     ...
     *
     * <p>Usually not needed since set() logs automatically,
